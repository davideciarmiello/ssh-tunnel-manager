...
{
    public class NetStatPortsAndProcessNames
    {
        // ===============================================
                    ...
                    foreach (string row in rows)
                    {
                        ...
                        if (tokens.Length > 4 && (tokens[1].Equals("UDP") || tokens[1].Equals("TCP")))
                        {
                            ...
                            Ports.Add(new Port
                            {
                                ...
                                process_id = tokens[1] == "UDP" ? (Convert.ToInt16(tokens[4])) : (Convert.ToInt16(tokens[5])),
                            });
                        }
                    }
                }
        ...
        public class Port
        {
            ...
            public string process_name => _processName ?? (_processName = LookupProcess(process_id));
